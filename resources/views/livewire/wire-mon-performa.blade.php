     ...
     <div class="col-xl-3 col-lg-4">
         ...
         <div class="card">
             ...
             <div class="card-body">
                 ...
                 <div class="form-group">
                     <label>Tanggal Performa<span class="text-danger">*</span></label>
                     <div wire:ignore class="date" id="appointmentDate" data-target-input="nearest"
                         ...
                         <input type="text" class="form-control datetimepicker-input" data-target="#appointmentDate"
                             id="appointmentDateInput" data-toggle="datetimepicker" placeholder="Tanggal Performa">
                     </div>
                     @error('tanggal_performa')
                 ...
                 <div class="form-group">
                     <label class="form-label">BSC<span class="text-danger">*</span></label>
                     <input wire:model="bsc" type="number" class="form-control" placeholder="e.g: BSC">
                     @error('bsc')
                         <small class="mt-2 text-danger">{{ $message }}</small>
                     @enderror
                 </div>
