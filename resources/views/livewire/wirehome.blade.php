                    ...
                    <div class="latest-timeline scrollbar3" id="scrollbar3">
                        <ul class="timeline mb-0">
                            <li class="mt-0">
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Joseph Ellison</span> finished task
                            ...
                            <li>
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Sonia Peters</span> finished target
                            ...
                            <li>
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Nicola Blake</span> visit the site<a
                                        href="{{ url('/' . ($page = '#')) }}" class="font-weight-semibold">
                                        Membership
                                        allocated</a></p>
                            </li>
                            <li>
                                ...
                                <p class="text-muted fs-12"><span class="text-info">Richard Mills</span> source report
                                    on<a href="{{ url('/' . ($page = '#')) }}" class="font-weight-semibold">
                                        Generated</a>
                                </p>
                            </li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="country-card">
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="{{ URL::asset('assets/images/flags/us.svg') }}"
                        ...
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="{{ URL::asset('assets/images/flags/in.svg') }}"
                        ...
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="{{ URL::asset('assets/images/flags/ru.svg') }}"
                        ...
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="{{ URL::asset('assets/images/flags/ca.svg') }}"
                        ...
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="{{ URL::asset('assets/images/flags/ge.svg') }}"
                        ...
                        <div class="mb-5">
                            <div class="d-flex">
                                <span class=""><img src="{{ URL::asset('assets/images/flags/br.svg') }}"
                        ...
                        <div class="mb-0">
                            <div class="d-flex">
                                <span class=""><img src="{{ URL::asset('assets/images/flags/au.svg') }}"
